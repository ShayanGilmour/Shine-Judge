...
cp /var/www/html/judge_cpp.sh /var/www/html/startup/judge.sh
cp /var/www/html/submitReq/code.py /var/www/html/startup/
cp /var/www/html/submitReq/code.cpp /var/www/html/startup/
...
cp /var/www/html/submitReq/code.cpp "$USER/$SUBM"
